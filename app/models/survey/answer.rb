class Survey::Answer < ActiveRecord::Base
  ...
  validates :predefined_value_id, :presence => true , :if => Proc.new{|a| a.question && a.question.predefined_values.count > 0 && !([Survey::OptionsType.text].include?(a.option.options_type_id))  }
